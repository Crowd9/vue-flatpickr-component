...
var allEvents = includedEvents.concat(excludedEvents); // Passing these properties in `set()` method will cause flatpickr to trigger some internal callbacks
...
/* harmony default export */ var component = ({
  ...
  mounted: function mounted() {
    ...
    this.fp = new external_flatpickr_default.a(this.getElem(), safeConfig); // Immediate watch will fail before fp is set,
  ...
  watch: {
     ...
     * @param newValue
     */
    value: function value(newValue, prevValue) {
      // Prevent updates if v-model value is same as input's current value
      // [1]
      if (JSON.stringify(newValue) === JSON.stringify(prevValue)) return; // [2]
